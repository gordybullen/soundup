...
class TrackForm extends React.Component {
  ...
  uploadAudioFile() {
    return (
      <>
        <div className="track-form-message">Drag and drop your track here</div>
        <label className="track-input-container">
          or choose a track to upload
          <input
            type="file"
    ...
    return (
      <form onSubmit={this.handleSubmit} className="basic-info-form">
        <div className="basic-info-form-content">
          <div className="basic-info-form-header">Basic info</div>
